  ...
  return (
    <div>
      ...
      >
        ...
        <Box height="400px">
            <Image 
            src="https://th.bing.com/th/id/R.797e4ba481b7b05e44b8b749f0d1c327?rik=EyJdSYsemHoy3A&riu=http%3a%2f%2fstatic.soposted.com%2fuploads%2f2017%2f11%2ffitness1.jpg&ehk=nChGHbTPsJkKhNk7b6XQPnVXvuLhM8H9gQo58%2bc5EQs%3d&risl=&pid=ImgRaw&r=0"
            alt="Track Athletes"
            h="80%"
            w="80%"
            m="auto"
      ...
      <Box mt={100}>
        ...
        <Text fontSize="2xl" mb={10}>
          MyFitness Hub encourages you to not just count your <br/> calories but
        ...
        >
          ...
          >
            <Box display="flex">
              ...
              <Box>
                <Text fontSize="3xl">Supportive Community</Text>
                <Text fontSize="md">
            ...
            <SimpleGrid columns={[1, 1, 2, 2, 2, 2]} spacing={1}>
              ...
              <Box py={5}>
                <Heading as="h3" size="lg" color="teal">
                  ...
                  or just maintenance - everyone should be using MyFitness Hub.
                </Heading>
                <Image
                  src="https://cdn1.cronometer.com/webflow/ios-icon.svg"
                  alt="app-store"
