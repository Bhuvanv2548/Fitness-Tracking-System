...
import { Box, Container, Flex, Heading, Image, Input, InputGroup, InputLeftElement, Text } from "@chakra-ui/react"
...
const Subsciption = () => {
  return (
   ...
   <Text  fontSize={30}>
       Getting Started with MyFitness Hub Pro
       </Text>
       <Text m={3} fontSize={20}>
       Welcome to MyFitness Hub Pro!
       </Text>
   ...
   Step 1: Log into your account
       ...
       <Text m={3} >
       To start, log into MyFitness Hub in a new tab or window of your web browser.
       </Text>
       <Link  to="/login" > <Text color="rgba(255, 103, 51, 1)" m={3}>Log in</Text>
       </Link>
       <Container maxW="2xl">
        <Text>Please note the MyFitness Hub Pro interface is only accessible on our website, and is not currently available on the mobile app. When your clients are using MyFitness Hub, they can use Cronometer on the web or on the mobile app.</Text>
        <Text>‍
Once you’ve logged in to your account, hover your mouse over the MyFitness Hub logo in the top left-hand corner and ensure you have your Pro account selected.</Text>
       </Container>
       <Image src="https://support.MyFitness Hub.com/hc/article_attachments/4405054762644/Account_switcher.png" alt="img" w="90%"/>
       <Text m={3} >
       ...
       <Text m={3} >
       In the main navigation at the top, you can add your company name and logo under Settings then Branding.<br/> This information will populate in your client’s diary.
       </Text>
       <Text m={3} >
       ...
       <Text m={3} >
       You can also add your company information to our Directory of Healthcare Professionals under Settings then Listing.<br/> This gets your business in front of our extensive user base and could potentially land you new clients.
       </Text>
       ...
       <Text>Once your clients have accepted your invitation, they will receive access to the premium Gold version of MyFitness Hub. This is a benefit included in your plan to which you get to extend the added value to your clients.</Text>
       </Container>
       <Image src="https://support.cronometer.com/hc/article_attachments/4405039697044/Add_Client.png" alt="img" w="641px" h="400px"/>
       <Text m={3} fontSize={20}>
       Step 4 : Get to Know MyFitness Hub
       </Text>
       <Container maxW="2xl">
        <Text>
