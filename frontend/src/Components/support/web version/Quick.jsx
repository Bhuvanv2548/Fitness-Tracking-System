...
import { Box, Container, Flex, Heading, Image, Input, InputGroup, InputLeftElement, ListItem, Text, UnorderedList } from "@chakra-ui/react"
...
<Box m={3}>
    ...
    <Text m={3} >
    Sign up for an account with MyFitness Hub at <Link color="rgba(255, 103, 51, 1)"> https://cronometer.com/signup/</Link>
    </Text>
