...
import { Box, Container, Flex, Heading, Image, Input, InputGroup, InputLeftElement, ListItem, OrderedList, Text } from "@chakra-ui/react"
...
const Mquick = () => {
  ...
  <Heading fontSize={30} >Mobile - Quick Start Guide</Heading>
      ...
      Welcome to MyFitness Hub!
      </Text>
    
  <OrderedList>
    <Container maxW="2xl">
    <ListItem m={5}>
        <Text mb={5}>Download the MyFitness Hub app from the Google Play Store or Apple Store.</Text>
    ...
    <ListItem m={5}>
        <Text m={5}>Tap on the Sign-Up button to create a new account. Use the Login button if you already have a MyFitnessHub account.</Text>
    ...
    <ListItem m={5}>
        <Text m={5}> Access the Diary tab and tap on the orange '+' to Add Foods and more:</Text>
