            ...
            <Stack spacing={4}>
              ...
              <Text fontSize={15} fontStyle={"italic"}>
                *By checking the box below you are indicating that you have read and
                agree to our <p style={{color:"orange", fontWeight:"500"}}>Terms of Service <font style={{color:"black", fontWeight:"400"}}>and</font> <font style={{color:"orange", fontWeight:"500"}}> Privacy Policy</font>.</p>
              </Text>

              <Checkbox>
                I agree to the MyFitness Hub Terms of Service and Privacy Policy.
              </Checkbox>
              <Text>
                In order to give you the best experience using MyFitness Hub, we
                need certain data permissions. (These are optional and can be
                updated in your settings any time.)
              </Text>
              <Checkbox>
                I agree to receive MyFitness Hub newsletter and promotional emails.
