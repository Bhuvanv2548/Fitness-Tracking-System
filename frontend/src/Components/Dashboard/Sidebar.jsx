import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Divider, Flex, Stack, Text } from '@chakra-ui/react'
import React, { useState } from 'react'
import { AiFillDollarCircle, AiFillQuestionCircle, AiFillSetting, AiOutlineMenu } from "react-icons/ai"
...
<Flex justifyContent='space-around' py={4} _hover={{color:'orange.500' }} >
    <Text style={{display: isopen ?  "block" : "none"}} fontSize='18px' fontWeight='bold'> MyFitness Hub </Text>
